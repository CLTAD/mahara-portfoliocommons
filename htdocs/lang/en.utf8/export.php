...
$string['allmypublicdata'] = 'All my public data (you can only export public content to a remote destination)';
...
$string['exportgeneratedsuccessfully'] = 'Export generated successfully. %sClick here to jump on it%s';
$string['exportgeneratedsuccessfully1'] = 'Export generated successfully.';
$string['depositmadesuccessfully'] = 'Deposit made successfully. %sContinue%s';
...
$string['justsomepublicviews'] = 'Just some of my public pages';
...
$string['publicviewstoexport'] = 'Public pages to export';
