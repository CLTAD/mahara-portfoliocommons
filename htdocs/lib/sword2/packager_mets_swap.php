...
class PackagerMetsSwap {
    ...
    function setAccessRights($sac_accessrights) {
        $this->sac_accessrights = $sac_accessrights;
    }
    ...
    function writeDmdSec($fh) {
        ...
        if (isset($this->sac_accessrights)) {
            $this->statementValueURI($fh,
                    "http://purl.org/dc/terms/accessRights",
                    $this->sac_accessrights);
        }
        ...
        $this->statement($fh, 
                         "http://purl.org/dc/elements/1.1/rights",
                         $this->valueString("Attribution-NonCommercial-NoDerivs 2.0"));
