...
require("sword2/swordappservicedocument.php");
require("sword2/swordappentry.php");
require("sword2/swordappresponse.php");
require("sword2/swordappstatement.php");
require("sword2/swordapperrordocument.php");
require("sword2/swordapplibraryuseragent.php");
require("sword2/stream.php");
require_once("sword2/utils.php");
...
class SWORDAPPClient {
    ...
    private function depositMultipartByMethod($sac_url, $sac_u, $sac_p, $sac_obo, $sac_package, $sac_method,
        ...
        curl_setopt($sac_curl, CURLOPT_HTTP_VERSION, CURL_HTTP_VERSION_1_0); // for SSS
        curl_setopt($sac_curl, CURLOPT_HTTPHEADER, $headers);
